...
export const TRADER_MISSIONS: TraderMission[] = [
  {
    ...
    meditacionRecomendada: "El Despertar del Trader Consciente",
  },
  {
    id: "mision-2",
    dia: 2,
    ...
    meditacionRecomendada: "La Visión del Guerrero",
  },
  {
    id: "mision-3",
    dia: 3,
    ...
    meditacionRecomendada: "La Lección de la Pérdida",
  },
  {
    id: "mision-4",
    dia: 4,
    ...
    meditacionRecomendada: "El Hábito que Transforma",
  },
  {
    id: "mision-5",
    dia: 5,
    ...
    meditacionRecomendada: "El silencio del trader maduro",
  },
  {
    id: "mision-6",
    dia: 6,
    ...
    meditacionRecomendada: "La Calma en la Tormenta",
  },
  {
    id: "mision-7",
    dia: 7,
    ...
    meditacionRecomendada: "Anclando la Constancia",
  },
  {
    id: "mision-8",
    dia: 8,
    ...
    meditacionRecomendada: "No es el mercado, eres Tú",
  },
  {
    id: "mision-9",
    dia: 9,
    ...
    meditacionRecomendada: "Tus emociones no son tu estrategia",
  },
  {
    id: "mision-10",
    dia: 10,
    ...
    meditacionRecomendada: "Motivación o constancia: Elige quién te entrena",
  },
  {
    id: "mision-11",
    dia: 11,
    ...
    meditacionRecomendada: "El Observador Silencioso",
  },
  {
    id: "mision-12",
    dia: 12,
    ...
    texto: `Revisa tu gestión de riesgo actual. ¿Es coherente con el capital que tienes HOY? ¿Tu stop loss es un número fijo o una decisión emocional? Escribe tu plan de gestión de riesgo en detalle. Este es tu escudo de tu capital. Sin él, estás operando a ciegas. ¿Estás dispuesto a protegerlo?`, 
    ...
    meditacionRecomendada: "Gestión de riesgo: el escudo del trader",
  },
  {
    id: "mision-13",
    dia: 13,
    ...
    meditacionRecomendada: "Neutralidad ante la Incertidumbre",
  },
  {
    id: "mision-14",
    dia: 14,
  ...
  },
  {
    ...
    meditacionRecomendada: "La Maestría Emocional",
  }
];
