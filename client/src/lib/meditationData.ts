...
const DESPEDIDA = "\n\nRecuerda este momento si lo necesitas a lo largo del día no solo en tu trading , tambien en tu vida cotidiana. Te espero, hasta la proxima.";
