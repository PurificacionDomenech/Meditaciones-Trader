...
export const meditacionesPredefinidas: Meditacion[] = [
  ...
  {
    id: "cafe-7",
    titulo: "Una cuenta quemada una lección cara",
    categoria: "Café con Rafa",
    categoriaId: "cafe",
    duracion: "5 min",
  ...
  {
    id: "cafe-8",
    titulo: "Menos operaciones más resultados",
    categoria: "Café con Rafa",
    categoriaId: "cafe",
    duracion: "5 min",
  ...
  },
  {
    ...
    texto: "Cierra los ojos. Respira profundo.\n\nHoy vamos a desmantelar una ilusión. La ilusión más poderosa del sistema.\n\nPiensa en el dinero. ¿Qué es realmente? Papel. Tinta. En tu pantalla, ni siquiera eso. Números. Rojos. Verdes.\n\nPixeles parpadeantes en una pantalla.\n\nPero le damos poder. Un poder inmenso. Le damos control sobre nuestras emociones. Sobre nuestras decisiones.\n\nRespira eso. Siente cómo tu pecho se expande.\n\nEl mercado no es real. Es un acuerdo colectivo. Una alucinación compartida.\n\nTú decides creer que ese número verde significa algo. Y al creerlo, lo hace real.\n\nPero también puedes decidir no darle el control de tu paz.\n\nEl dinero es una herramienta. Tu creación. No tu amo.\n\nCuando ves rojo en pantalla, ¿qué sientes? Miedo. Ansiedad. Tu cuerpo se tensa.\n\nPero son solo números cambiando. Información. Datos.\n\nInhala claridad. Exhala el apego.\n\nTú le diste poder al dinero. Y tú puedes quitárselo.\n\nNo estás operando dinero real. Estás operando probabilidades. Jugando con números que representan un acuerdo social.\n\nVisualízate frente a las pantallas. Sereno. Observando los números moverse como nubes en el cielo.\n\nSin apego. Sin miedo. Con respeto, sí. Pero sin adoración.\n\nRecupera tu poder. El dinero es tu herramienta, no tu dios.\n\nAbre los ojos. Opera con la perspectiva de quien comprende el juego."
  },
  {
    id: "vision-2",
    titulo: "El Observador Silencioso",
    categoria: "III. La Visión Clara del Mercado",
    categoriaId: "vision",
    duracion: "8-10 min",
    descripcion: "Desarrolla la capacidad de observar el mercado sin proyectar tus deseos sobre él.",
    texto: "Cierra los ojos. Encuentra tu centro.\n\nHoy practicamos el arte más difícil del trading: ver lo que es, no lo que quieres que sea.\n\nRespira profundamente. Siente cómo el aire entra y sale sin esfuerzo.\n\nEl mercado no sabe que existes. No le importas. No está en tu contra ni a tu favor.\n\nSimplemente es.\n\nPero tú proyectas. Proyectas esperanza cuando estás en verde. Proyectas miedo cuando estás en rojo.\n\nVes patrones donde quieres verlos. Ignoras señales que no te gustan.\n\nInhala objetividad. Exhala el sesgo.\n\nConviértete en el observador. No en el protagonista. El mercado no es tu enemigo ni tu salvador.\n\nEs un río. Tú solo decides cuándo entrar y cuándo salir.\n\nVisualiza tus gráficos. Sin emoción. Solo información. Velas que suben. Velas que bajan.\n\nDatos puros.\n\n¿Ves lo que hay? ¿O ves lo que necesitas?\n\nEl trader amateur proyecta sus necesidades. El profesional observa la realidad.\n\nRespira esa claridad. Esa frialdad necesaria.\n\nNo estás aquí para tener razón. Estás aquí para leer correctamente.\n\nAbre los ojos. Observa sin juzgar. Analiza sin desear."
  },
  {
    id: "vision-3",
    ...
    categoriaId: "vision",
    duracion: "7-9 min",
    descripcion: "Cultiva la disciplina de esperar tu momento, sin forzar operaciones.",
    texto: "Respira. Suelta la urgencia.\n\nHoy practicas el arte más rentable del trading: no hacer nada.\n\nCierra los ojos. Siente tu cuerpo inmóvil. Relajado. Alerta, pero sin tensión.\n\nAsí es el cazador. Horas esperando. Quieto. Paciente.\n\nNo dispara a todo lo que se mueve. Espera a su presa. Espera su momento.\n\nTú eres ese cazador.\n\nEl mercado te tienta constantemente. Movimientos. Volatilidad. Oportunidades aparentes.\n\nPero el 90% son trampas. Ruido. Movimientos sin tu setup.\n\nInhala paciencia. Exhala ansiedad.\n\nNo necesitas operar todos los días. No necesitas estar en posición constantemente.\n\nTu ventaja no está en la acción. Está en la selección.\n\nVisualízate esperando. Horas si es necesario. Días incluso.\n\nTu setup no ha aparecido. Y está bien.\n\nCash es una posición. La mejor, muchas veces.\n\nRespira esa tranquilidad. El mercado no se va a ningún lado.\n\nEl trader desesperado pierde. El trader paciente gana.\n\nNo confundas actividad con productividad. A veces, no hacer nada es la mejor operación del día.\n\nAbre los ojos. Espera tu momento. Y cuando llegue, actúa sin dudar."
  },
  {
    id: "vision-4",
    ...
    categoriaId: "vision",
    duracion: "8-10 min",
    descripcion: "Conecta con la importancia del análisis objetivo y el respeto por tu sistema.",
    texto: "Encuentra tu postura. Cierra los ojos.\n\nHoy honramos la única verdad del trading: los datos.\n\nNo tus corazonadas. No tu intuición. No lo que sientes.\n\nLos números no mienten. Tu sistema no miente.\n\nRespira profundamente. Inhala claridad.\n\nHas probado tu sistema. Tienes tu edge. Conoces tus probabilidades.\n\nPero en medio de la sesión, lo olvidas. Dudas. Modificas. Improvisas.\n\nY pierdes.\n\nEl mercado recompensa la consistencia, no la creatividad.\n\nExhala la necesidad de ser especial. De tener el trade perfecto.\n\nTu ventaja está en la repetición. En ejecutar tu sistema una y otra y otra vez.\n\nVisualiza tu journal. Tus estadísticas. Tu winrate. Tu R:R.\n\nEsos números son tu verdad. Tu mapa en medio del caos.\n\nCuando sientas la tentación de salirte del plan, respira. Vuelve a los números.\n\nTu sistema existe por una razón. Lo construiste en frío, con lógica.\n\nNo lo destruyas en caliente, con emoción.\n\nInhala confianza en tu proceso. Exhala la duda.\n\nEres un científico. Haces experimentos. Recoges datos. Ajustas.\n\nPero siempre desde la objetividad. Nunca desde el miedo o la euforia.\n\nAbre los ojos. Confía en tus números. Ejecuta tu sistema."
  },
  {
    id: "maestria-1",
    ...
    texto: "Cierra los ojos. Respira profundo.\n\nHoy no huimos del miedo. Hoy lo miramos de frente.\n\nEl miedo es tu compañero constante en el mercado. Miedo a perder. Miedo a perderte el movimiento. Miedo a equivocarte.\n\nPero el miedo no es tu enemigo. Es información.\n\nInhala profundamente. Siente dónde vive el miedo en tu cuerpo. ¿En el pecho? ¿En el estómago?\n\nObsérvalo. No lo juzgues. Solo reconócelo.\n\nEl trader amateur lucha contra el miedo. El profesional lo escucha y decide conscientemente.\n\nExhala lentamente. Suelta la resistencia.\n\nTu miedo a perder te protege. Pero también te paraliza cuando más necesitas actuar.\n\nVisualiza tu próxima operación. Sientes el miedo aparecer. El impulso de cerrar antes de tu stop. De no entrar cuando tu setup está perfecto.\n\nRespira con ese miedo. No lo elimines. Inclúyelo.\n\nPregúntale: ¿Es miedo racional o emocional? ¿Protege mi capital o protege mi ego?\n\nEl miedo racional dice: 'Este trade viola tu plan'. Escúchalo.\n\nEl miedo emocional dice: 'Podrías perder'. Agradécelo y actúa igual.\n\nInhala coraje. No la ausencia de miedo, sino la acción a pesar del miedo.\n\nAbre los ojos. Opera con miedo, sí. Pero opera igual."
  },
  {
    id: "maestria-2",
    ...
    texto: "Encuentra tu centro. Cierra los ojos.\n\nHoy hablamos del enemigo silencioso: la victoria.\n\nEstás en racha. Tres trades verdes. Cinco. Diez.\n\nTe sientes invencible. El mercado tiene sentido. Todo es fácil.\n\nY justo ahí es cuando caes.\n\nRespira profundamente. Siente la tentación de la euforia.\n\nLa euforia es más peligrosa que el miedo. El miedo te paraliza. La euforia te destruye.\n\nInhala humildad. Exhala arrogancia.\n\nNo eres más listo cuando ganas. No tienes superpoderes. No has descifrado el mercado.\n\nSimplemente, las probabilidades jugaron a tu favor. Esta vez.\n\nVisualízate después de una racha ganadora. Sientes la tentación. Aumentar el size. Saltarte las reglas. 'Una más, está fácil'.\n\nDetente. Respira.\n\nEl mercado no te debe nada. Tu siguiente trade tiene las mismas probabilidades que el primero.\n\nLa estadística no tiene memoria. No le importa que hayas ganado diez seguidas.\n\nExhala la necesidad de más. De seguir. De exprimir.\n\nEl trader disciplinado gana tres y para. Revisa. Respeta su plan.\n\nEl trader eufórico gana tres y pierde cinco.\n\nRespira ecuanimidad. Ni euforia en victoria ni desesperación en derrota.\n\nAbre los ojos. Trata cada trade como si fuera el primero."
  },
  {
    id: "maestria-3",
    ...
    texto: "Respira. Suelta el control.\n\nCierra los ojos. Siente tu cuerpo relajarse.\n\nHoy practicamos la rendición. No la derrota. La rendición inteligente.\n\nNo controlas el mercado. No controlas si tu trade gana o pierde. No controlas la volatilidad.\n\nY está bien.\n\nInhala aceptación. Exhala frustración.\n\nEl trader amateur quiere controlar el resultado. El profesional solo controla el proceso.\n\n¿Qué controlas? Tu entrada. Tu stop. Tu size. Tu disciplina.\n\nNada más.\n\nVisualiza un trade que se va a stop. Siente el impulso de mover el stop. De 'darle aire'. De no aceptar que el mercado no te dio la razón.\n\nSuelta. Ríndete a la realidad del momento.\n\nEl mercado es un océano. No puedes controlar las olas, solo puedes aprender a surfearlas.\n\nY surfear significa aceptar que a veces te caerás.\n\nRespira esa paz. La paz de no tener que controlar lo incontrolable.\n\nEres libre cuando dejas de pelear con el precio.\n\nAbre los ojos. Acepta el mercado como es, no como quieres que sea."
  },
  {
    id: "maestria-4",
    ...
    texto: "Cierra los ojos. Encuentra la quietud.\n\nHoy aprendes a crear espacio. Espacio entre tú y tu mente.\n\nTus pensamientos no eres tú. Son eventos que suceden en tu consciencia.\n\nRespira profundamente. Observa tus pensamientos como nubes pasando.\n\n'Voy a perder'. 'Debería haber entrado'. 'Este mercado es imposible'.\n\nSon solo pensamientos. No verdades. No órdenes. Simplemente ruido mental.\n\nInhala claridad. Exhala identificación.\n\nNo eres tus pensamientos. Eres el espacio donde ocurren.\n\nVisualízate operando. Un pensamiento de duda aparece. Míralo. Sonríele. Déjalo pasar.\n\nNo necesitas actuar sobre cada pensamiento. No necesitas creer cada historia que tu mente te cuenta.\n\nTu mente es una máquina de generar escenarios, la mayoría falsos.\n\nRespira el silencio que hay detrás del ruido.\n\nCuando logras observar tu mente sin ser arrastrado por ella, alcanzas la verdadera libertad del trader.\n\nAbre los ojos. Observa tu mente, pero sigue tu plan."
  },
  {
    id: "recuperacion-1",
    ...
    texto: "Cierra los ojos. Respira, aunque duela.\n\nHoy estás aquí porque perdiste. Quizás mucho. Quizás duele.\n\nY está bien sentir ese dolor.\n\nNo lo niegues. No finjas fortaleza que no sientes. El dolor es real.\n\nInhala profundamente. Siente el peso en tu pecho.\n\nPero ahora escucha esto: Una pérdida no te define. Un mal día no borra tu camino.\n\nExhala lentamente. Suelta la vergüenza.\n\nTodos los grandes traders han estado donde estás ahora. Todos.\n\nLa diferencia entre el que lo logra y el que abandona no es que el primero no pierda, sino cómo se levanta.\n\nVisualiza tu pérdida. Mírala como una factura pagada a la universidad del mercado. Es educación, no castigo.\n\nRespira autocompasión. Fuiste valiente al intentarlo. Sé valiente ahora al perdonarte.\n\nMañana el sol volverá a salir. El mercado volverá a abrir.\n\nNo entres hoy. No operes con dolor. Cura la herida primero.\n\nAbre los ojos. Eres más fuerte que tu drawdown."
  },
  {
    id: "recuperacion-2",
    ...
    texto: "Encuentra tu postura. Cierra los ojos.\n\nSientes la urgencia. El fuego en el pecho. La necesidad de recuperar.\n\nAhora. Ya. El siguiente trade.\n\nDetente. Respira.\n\nEse impulso te va a destruir.\n\nInhala claridad. Exhala venganza.\n\nEl mercado no te quitó nada. No es tu enemigo. No te debe nada.\n\nTú tomaste una decisión. El mercado respondió. Eso es todo.\n\nPero tu ego está herido. Y el ego herido es peligroso.\n\nQuiere recuperar. Quiere tener razón. Quiere vengarse.\n\nNo puedes ganar una guerra contra el mercado. Porque el mercado ni siquiera sabe que estás peleando.\n\nVisualiza tu impulso de revancha. Es una sombra oscura. Respira y deja que se disuelva.\n\nNo necesitas recuperar hoy. Necesitas proteger lo que te queda hoy.\n\nApaga la pantalla. Sal a caminar. Rompe el ciclo.\n\nAbre los ojos. El mercado te esperará cuando estés en paz."
  },
  {
    id: "recuperacion-3",
    ...
    texto: "Cierra los ojos. Respira profundo.\n\nHoy borramos. Limpiamos. Reseteamos.\n\nLlevas días, quizás semanas, perdiendo. La confianza está rota.\n\nCada trade nuevo lo inicias esperando perder.\n\nY así, lo haces realidad.\n\nInhala profundamente. Exhala esa carga.\n\nTu sistema no cambió. El mercado no cambió. Tú cambiaste.\n\nTe dejaste infectar por la racha.\n\nPero una racha perdedora es solo estadística. Ruido. Parte del juego.\n\nRespira esa perspectiva.\n\nCada trade es independiente. Lo que pasó ayer no afecta las probabilidades de hoy.\n\nVisualiza una pizarra blanca. Limpia. Sin deudas. Sin rencores.\n\nTu cuenta está donde está. Ese es tu nuevo punto de partida. Olvida lo que tenías antes.\n\nOpera desde el presente, no desde la nostalgia de tu pico de capital.\n\nInhala neutralidad. Exhala el pasado.\n\nAbre los ojos. Empieza de cero. Con humildad y rigor."
  },
  {
    id: "recuperacion-4",
    ...
    texto: "Respira. Encuentra tu centro.\n\nCierra los ojos. Hoy honramos algo poderoso: tu resistencia.\n\nHas llegado hasta aquí. A pesar de las pérdidas. A pesar del dolor.\n\nSigues aquí. Eso dice todo.\n\nInhala esa verdad. Exhala la autocompasión destructiva.\n\nLa adversidad no te rompe. Te revela.\n\nRevela si eres un turista buscando dinero fácil o un profesional construyendo un oficio.\n\nLos turistas huyen al primer drawdown. Los profesionales se adaptan.\n\nRespira esa identidad de profesional.\n\nEl fracaso es el abono del éxito. Cada error es una pieza del rompecabezas de tu maestría.\n\nVisualízate dentro de un año. Exitoso. Consistente. Mirando hacia atrás a este momento.\n\nVerás que este dolor fue necesario. Fue el fuego que forjó el acero.\n\nInhala fuerza. Exhala duda.\n\nNo te rindas. Solo descansa. Calibra. Y vuelve con más sabiduría.\n\nAbre los ojos. La gloria te espera al otro lado de tu perseverancia."
  },
  {
    id: "proyeccion-1",
    ...
    texto: "Cierra los ojos. Respira profundo. Hoy volamos alto.\n\nImagina un águila imperial. Solitaria. En lo alto de una montaña.\n\nObserva cómo despega. Sin prisa. Con poder. Extiende sus alas y se eleva.\n\nNo aletea frenéticamente como las aves pequeñas. No persigue. No se agota.\n\nUsa las corrientes. Lee el viento. Se eleva sin esfuerzo.\n\nInhala profundamente. Siente esa calma.\n\nEl águila ve lo que otros no ven. Desde arriba, tiene perspectiva completa.\n\nMientras abajo hay caos, arriba hay visión.\n\nTú eres esa águila. El mercado es tu territorio.\n\nNo necesitas cazar cada movimiento. Esperas la oportunidad real. La ves desde lejos.\n\nY cuando llega, te lanzas. Con precisión quirúrgica. Sin duda.\n\nVisualízate operando con esa visión de águila. Desapegado. Soberano. En control absoluto de tus emociones.\n\nRespira esa libertad. La libertad de quien ya no lucha, sino que fluye.\n\nEres un trader de élite. No por tus ganancias, sino por tu mentalidad.\n\nAbre los ojos. Mira el mercado desde las alturas."
  },
  {
    id: "proyeccion-2",
    ...
    texto: "Cierra los ojos. Respira suavemente.\n\nHoy hablamos de transformación. Real. Profunda. Dolorosa.\n\nPiensa en una oruga. Lenta. Vulnerable. Arrastrándose por el suelo.\n\nUn día, algo en ella le dice que es hora. Se envuelve en un capullo.\n\nOscuridad total. Soledad absoluta.\n\nInhala profundamente. Siente esa oscuridad.\n\nDentro del capullo, la oruga no se transforma gradualmente. Se desintegra.\n\nLiteralmente se disuelve. Convierte su cuerpo en sopa.\n\nTodo lo que creía ser muere para dejar paso a lo que está destinada a ser.\n\nHas vivido momentos así en el trading. Momentos de duda total. De sentir que no sirves para esto.\n\nEsa es tu sopa de oruga. Es necesaria.\n\nExhala el miedo a la disolución. Estás dejando atrás al trader amateur.\n\nVisualiza cómo tus alas empiezan a formarse. De la nada. De la oscuridad.\n\nPronto romperás el capullo. Y volarás. Con colores que ni imaginabas.\n\nPero respeta el tiempo en la oscuridad. Respeta tu proceso.\n\nAbre los ojos. Confía en tu metamorfosis."
  },
  {
    id: "proyeccion-3",
    ...
    texto: "Cierra los ojos. Respira profundo.\n\nHoy construimos. Ladrillo por ladrillo. La vida que mereces.\n\nNo estás aprendiendo a hacer dinero. Eso es secundario.\n\nEstás aprendiendo a construir libertad. A diseñar existencia.\n\nInhala esa visión expandida.\n\nPiensa en los arquitectos de catedrales medievales. Sabían que no verían la obra terminada.\n\nTrabajaban para algo más grande que ellos. Un legado. Una visión.\n\nTú también eres arquitecto. Pero no de piedra, sino de tiempo.\n\n¿Qué harás con tu libertad? ¿Cómo ayudarás a otros? ¿Qué ejemplo serás?\n\nVisualiza tu vida ideal. No solo los lujos, sino la paz. La calidad de tus relaciones. Tu salud. Tu contribución al mundo.\n\nEl trading es el motor, pero tú eres el conductor.\n\nRespira el propósito detrás de cada clic. De cada hora de estudio.\n\nNo construyes para hoy. Construyes para siempre.\n\nExhala la gratificación instantánea. Inhala la visión a largo plazo.\n\nAbre los ojos. Construye tu catedral."
  },
  {
    id: "proyeccion-4",
    ...
    texto: "Cierra los ojos. Respira profundo.\n\nHoy celebramos algo sagrado. Tu transformación.\n\nHas recorrido el camino. Desde el fundamento hasta aquí.\n\nDesde la ignorancia entusiasta hasta la maestría consciente.\n\nInhala con ese reconocimiento.\n\nRecuerda tu primer trade. La emoción. El miedo. La esperanza desmedida.\n\nEras un niño jugando en un campo de gladiadores.\n\nNo sabías lo que no sabías. Y esa ignorancia era peligrosa.\n\nPero también era necesaria. Porque te trajo hasta aquí.\n\nVisualiza todas las categorías anteriores. El fundamento. El escudo. La visión. La maestría. La recuperación.\n\nAhora, júntalas. Siente cómo se integran en tu ser.\n\nYa no eres alguien que 'hace' trading. Eres un trader.\n\nEs tu identidad. Tu forma de ver la vida. Con objetividad, disciplina y coraje.\n\nRecibes la corona invisible del profesional. No es de oro. Es de templanza.\n\nExhala el pasado. Inhala tu nuevo yo.\n\nEstás listo. El mercado es tu espejo. Y lo que ves hoy es reflejo de tu propia luz.\n\nAbre los ojos. Sal ahí fuera y ejerce tu maestría."
  }
];
